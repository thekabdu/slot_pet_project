...
abstract class $CategoriesModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String status, String message, List<String> categories});
}
...
class _$CategoriesModelImpl implements _CategoriesModel {
  ...
  @override
  String toString() {
    return 'CategoriesModel(status: $status, message: $message, categories: $categories)';
  }
...
abstract class _CategoriesModel implements CategoriesModel {
  const factory _CategoriesModel(
      ...
      required final List<String> categories}) = _$CategoriesModelImpl;
