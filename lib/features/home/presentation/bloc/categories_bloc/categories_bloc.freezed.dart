...
class __$$FetchImplCopyWithImpl<$Res>
    extends _$CategoriesStateCopyWithImpl<$Res, _$FetchImpl>
...
class _$FetchImpl implements _Fetch {
  const _$FetchImpl(final List<String> categories) : _categories = categories;
  ...
  @override
  String toString() {
    return 'CategoriesState.fetch(categories: $categories)';
  }
...
abstract class _Fetch implements CategoriesState {
  const factory _Fetch(final List<String> categories) = _$FetchImpl;
